...
function CounterCryptoWidget(props) {
  ...
  const smDown = useMediaQuery(theme => theme.breakpoints.down('sm')); // eslint-disable-line
        ...
        <Grid item md={3} xs={12}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              ...
              >
                <AreaChart width={smDown ? 250 : 100} height={60} data={data1}>
...
export default injectIntl(CounterCryptoWidget);
