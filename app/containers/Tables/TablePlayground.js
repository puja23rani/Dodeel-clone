...
function TablePlayground(props) {
  ...
  const [formState, setFormState] = useState({
    ...
    defaultPerPage: 10,
    filterText: "",
    size: propSize, // Controlled via props
    bordered: styles.bordered || false, // Controlled via props
    stripped: styles.stripped || false, // Controlled via props
    hovered: styles.hovered || false, // Controlled via props
    toolbar: toolbarOptions.enabled || true, // Controlled via props
    checkcell: toolbarOptions.checkcell || false, // Controlled via props
    pagination: toolbarOptions.pagination || true, // Controlled via props
  });
  ...
  const thisIsSelected = (id) => formState.selected.indexOf(id) !== -1;
